...
try {
    $sql = 'SELECT * FROM product where product_type = "film" and category = "Action/Aventure"';
    $sql2 = 'SELECT * FROM product where product_type = "film" and category = "Comedie"';
    $sql3 = 'SELECT * FROM product where product_type = "film" and category = "Anime"';
...
<?php include_once('include/json.names.php'); ?>
    <h1>FILM:</h1>
    <p class="qui-somme-nous">Bienvenu dans la page des Film.</p>
    <p class="qui-somme-nous">Choisissez un film</p>
    <span class="space"></span>
    <p class="Bientot">Populaire en ce moment</p>
    <div class="film2s-affiche">
        <div class="box">
            <div class="imgBx">
                <img class="bande-film" src="" alt="film">
            </div>
            <div class="content score-film">
                <h2 class="content-film"></h2>
                <h3 class="date-film"></h3>
            </div>
        </div>
...
<script src="js/api-film.js" defer></script>
